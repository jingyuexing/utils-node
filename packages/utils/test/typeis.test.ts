...
describe("test typeis", () => {
  ...
  it("test typeis", () => {
    expect(typeis([])).eq("array");
    expect(typeis({})).eq("object");
    expect(typeis(() => {})).eq("function");
    expect(typeis("")).eq("string");
    expect(typeis(12)).eq("number");
    expect(typeis(BigInt(12))).eq("bigint");
    expect(typeis(new Date())).eq("date");
    expect(typeis(new Map())).eq("map");
